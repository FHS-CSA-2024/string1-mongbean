...
public class String1
{
    ...
    public String extraEnd(String str) {
        int l = str.length();
        return str.substring(l-2,l)+str.substring(l-2,l)+str.substring(l-2,l);
    }
    ...
    public String conCat(String a, String b) {
        ...
        if (a.substring(la-1,la).equals(b.substring(0,1))){
            return a.substring(0,la-1) + b;
        }
        return a+b;
    }
    ...
    public String minCat(String a, String b) {
        ...
        if (la>lb){
            ...
            return a+(b.substring((lb-la),la+1));
        }
        return a+b;
    }
    ...
    public String withoutX(String str) {
        ...
        if (str.substring(l-1,l).equals("x")){
            end -= 1;
        }
    ...
    public String deFront(String str) { 
        ...
        if (str.charAt(1) == "b".charAt(0)){
            two = "b";
        }
        return one+two+str.substring(2,str.length());
    }
